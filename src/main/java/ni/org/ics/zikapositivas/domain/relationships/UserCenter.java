package ni.org.ics.zikapositivas.domain.relationships;
...
import ni.org.ics.zikapositivas.domain.BaseMetaData;
...
@Entity
@Table(name = "users_centers", catalog = "zika_positivas")
